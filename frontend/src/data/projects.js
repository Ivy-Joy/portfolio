...
const localProjects = [
  ...
  "slug": "acre",
  "summary": "ACRE (Automated Compliance & ROI Engine) is an API-first metadata intelligence platform that automatically links publications to grants, validates data availability and acknowledgements, scores \"Data Health\", and generates donor-ready reports - dramatically reducing manual M&E work for foundations and research programmes.",
